...
export const menuItems: MenuItem[] = [
  ...
  { label: "Products",   labelKey: "nav.products",            path: "/products",         icon: Boxes,             permission: "inventory.view",   group: "Inventory" },
  { label: "Receiving",  labelKey: "desktop.nav.receiving",   path: "/products/new",     icon: PackagePlus,       permission: "inventory.receive",group: "Inventory" },
  { label: "Stock & Batches", labelKey: "desktop.nav.stock",  path: "/stock",            icon: Layers,            permission: "inventory.view",   group: "Inventory" },
  { label: "Suppliers",  labelKey: "desktop.nav.suppliers",   path: "/suppliers",        icon: Building2,         permission: "suppliers.manage", group: "Inventory" },
