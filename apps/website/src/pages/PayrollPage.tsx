        ...
        <Reveal className="mt-28">
          <div className="shimmer-border">
            <div className="shimmer-inner p-12 sm:p-16 text-center">
              <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4">Curious how payroll gets verified?</h2>
              <p className="text-slate-400 max-w-xl mx-auto mb-9">Talk to us about the statutory trust layer, and see the platform on a real company setup.</p>
              <Magnetic>
